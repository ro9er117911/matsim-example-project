...
| Old | New |
|-----|-----|
| `AGENT.md` | `docs/04-population/agent-development.md` |
| `PT_ERROR_HANDLING.md` | `docs/03-public-transit/public-transit-guide.md` + `docs/10-troubleshooting/troubleshooting.md` |
| `PT_SETUP_REPORT.md` | `docs/03-public-transit/public-transit-guide.md` |
...
- **Config reference**: `defaultConfig.xml` + `docs/08-configuration/configuration-reference.md`
...
- `AGENT.md` - Replaced by `docs/04-population/agent-development.md`
- `PT_ERROR_HANDLING.md` - Merged into `docs/03-public-transit/public-transit-guide.md`
- `PT_SETUP_REPORT.md` - Merged into `docs/03-public-transit/public-transit-guide.md`
