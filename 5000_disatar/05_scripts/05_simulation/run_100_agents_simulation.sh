...
# [DEPRECATED] VIA visualization - now using SimWrapper
...
# [DEPRECATED] Step 4: Generate Via output - now using SimWrapper
# echo ""
...
echo "Next: Load output directory in SimWrapper for visualization"
echo "  npx simwrapper serve --port 8000"
echo "========================================================================"
