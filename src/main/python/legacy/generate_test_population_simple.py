...
Legacy, minimal version kept for reference. Use src/main/python/generate_test_population.py for the maintained generator with validation and bounds checks.
"""
