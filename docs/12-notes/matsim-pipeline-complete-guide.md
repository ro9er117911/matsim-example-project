...
| `gemini.md` | Gemini 專用指引 | 專案概覽、建置說明（較簡潔）|
...
1. **先閱讀記憶檔案**
   ```
   在開始任何任務前，先讀取 CLAUDE.md 或 gemini.md
   ```
...
| 文檔 | 用途 |
|------|------|
| [../01-getting-started/quick-start.md](../01-getting-started/quick-start.md) | 快速開始 |
| [../03-public-transit/public-transit-guide.md](../03-public-transit/public-transit-guide.md) | PT 完整指南 |
| [../05-simulation/simulation-guide.md](../05-simulation/simulation-guide.md) | 模擬執行指南 |
| [../10-troubleshooting/troubleshooting.md](../10-troubleshooting/troubleshooting.md) | 疑難排解 |
